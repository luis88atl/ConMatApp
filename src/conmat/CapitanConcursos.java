 ...
 */
public class CapitanConcursos extends javax.swing.JFrame {
    ...
    private void JbtnUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JbtnUsuariosMouseClicked
        ...
        CapitanConcursos pantallausuarios = new CapitanConcursos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapitanConcursos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapitanConcursos().setVisible(true);
            }
        });
    }
    ...
    private void CargaTabla() {
        try {
            ...
            Logger.getLogger(CapitanConcursos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
