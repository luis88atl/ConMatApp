...
public class AdministradorUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(JlbImageUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, 200, 220));
    ...
    private void BtnGuardaAltaUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGuardaAltaUsuarioActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            if ((Usuario.isEmpty() || Contrasena.isEmpty() || idperfil.isEmpty() || Asignacion.isEmpty())) {
                ...
                alta.GuardaUsuario(Usuario, Contrasena, idperfil, Activado, Asignacion);
                CargaTabla();
                LimpiaCampos();
            ...
            if ((Usuario.isEmpty() || Contrasena.isEmpty() || idperfil.isEmpty() || Asignacion.isEmpty())) {
                ...
                if (Contrasena.equals("******")) {
                    modificacion.SinContrasena(id, Usuario, idperfil, Activado, Asignacion);
                } else {
                    modificacion.ModificaUsuario(id, Usuario, Contrasena, idperfil, Activado, Asignacion);
                }
                CargaTabla();
                LimpiaCampos();
