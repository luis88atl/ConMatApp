...
public class Usuario {
    ...
    public void GuardaUsuario(String Usuario, String Contrasena, String Perfil, String Activado,
            String Asignacion, String rutaimagen) {
        try {
            ...
            db.insertaDatos("INSERT INTO USUARIOS VALUES("
                    ...
                    + "GETDATE(),"
                    + "'" + Asignacion + "', "
                    + "(select * FROM OPENROWSET(BULK '" + rutaimagen + "', SINGLE_BLOB) AS USUARIO),NULL)", st);
    ...
    public void ModificaUsuario(String Id, String Usuario, String Contrasena, String Perfil, String Activado, String Asignacion,
        ...
        try {
            ...
            db.insertaDatos("UPDATE USUARIOS SET USUARIO = '" + Usuario + "',"
                    ...
                    + "perfil = " + Perfil + ","
                    + "ACTIVO = " + Activado + ","
                    + "ASIGNACION = '" + Asignacion + "' WHERE ID = " + Id, st);

            if (foto == 1) {
                db.insertaDatos("UPDATE USUARIOS SET IMAGEN2=(select * FROM OPENROWSET(BULK '"
                        + rutaimagen + "', SINGLE_BLOB) AS USUARIOS) where Id = " + Id, st);
            }
